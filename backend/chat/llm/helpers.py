...
def get_llm_response(
    ...
    **kwargs,
    ...
    """
    # Only sanitize user-supplied input — system prompts are
    # developer-controlled strings and must not be modified.
    user_message = sanitize_input(user_message, max_length=16000)

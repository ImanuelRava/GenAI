...
This route module provides API endpoints for chemical data extraction.
All extraction logic is delegated to chemextract_extractor module.

Architecture:
- chemextract_extractor.py: Core extraction logic (HTTP-based LLM calls, async support)
- data_extraction.py: Flask routes that expose extraction as API endpoints
"""
...
# Vision-capable providers (for image-based extraction)
...
def merge_extraction_results(all_results: list) -> dict:
    ...
    for page_result in all_results:
        ...
        # Set reaction type and selectivity
